...
use crate::tests::e2e::steps::{
    ...
    check_third_tab_moved_left, check_third_tab_moved_to_beginning, check_third_tab_opened,
    move_tab_left, move_tab_right, new_tab, switch_focus_to_left_tab, type_second_tab_content,
};
...
fn check_third_tab_is_right_wrapped() -> Step {
    Step {
